...
! function(t, e) {
    ...
    function l(t, e) {
        return P.dom(t) && o(O, e) ? "transform" : P.dom(t) && (t.getAttribute(e) || P.svg(t) && t[e]) ? "attribute" : P.dom(t) && "transform" !== e && f(t, e) ? "css" : null != t[e] ? "object" : void 0
    }
    ...
    function p(t, r) {
        switch (l(t, r)) {
            case "transform":
                return function(t, r) {
                    var n, o = -1 < (n = r).indexOf("translate") || "perspective" === n ? "px" : -1 < n.indexOf("rotate") || -1 < n.indexOf("skew") ? "deg" : void 0;
                    if (o = -1 < r.indexOf("scale") ? 1 : 0 + o, !(t = t.style.transform)) return o;
                    for (var a = [], i = [], u = [], s = /(\w+)\((.+?)\)/g; a = s.exec(t);) i.push(a[1]), u.push(a[2]);
    ...
    function h(t, e) {
        function r(r) {
            return r = void 0 === r ? 0 : r, t.el.getPointAtLength(1 <= e + r ? e + r : 0)
        }
        var n = r(),
            o = r(-1),
            a = r(1);
    ...
    function j(t, e) {
        ...
        if (P.arr(t)) {
            var o = t.length;
            2 !== o || P.obj(t[0]) ? P.fnc(e.duration) || (r.duration = e.duration / o) : t = {
                value: t
            }
        }
        return n(t).map(function(t, r) {
            return r = r ? 0 : e.delay, t = P.obj(t) && !P.pth(t) ? t : {
                value: t
            }, P.und(t.delay) && (t.delay = r), t
        }).map(function(t) {
            return u(t, r)
        })
    }
    ...
    function $(t, e) {
        ...
        return t.tweens.map(function(n) {
            ...
            a = s(u) || s(i) || s(a);
            return n.from = v(i, a), n.to = v(u, a), n.start = r ? r.end : t.offset, n.end = n.start + n.delay + n.duration, n.easing = function(t) {
                return P.arr(t) ? k.apply(this, t) : F[t]
            }(n.easing), n.elasticity = (1e3 - Math.min(Math.max(n.elasticity, 1), 999)) / 1e3, n.isPath = P.pth(o), n.isColor = P.col(n.from.original), n.isColor && (n.round = 1), r = n
        })
    }
    ...
    function w(t) {
        var n, o, a, s, c = i(M, t),
            f = i(S, t),
            p = (o = t.targets, (a = b(o)).map(function(t, e) {
                return {
                    target: t,
                    id: e,
                    total: a.length
            ...
            d = [],
            m = u(c, f);
        for (n in t) m.hasOwnProperty(n) || "targets" === n || d.push({
            name: n,
            offset: m.offset,
            tweens: j(t[n], f)
        });
        return s = d, u(c, {
            children: [],
            animatables: p,
            animations: t = e(r(p.map(function(t) {
    ...
    function A(t) {
        ...
        function o(t) {
            for (var r = 0, n = {}, o = m.animations, a = o.length; r < a;) {
                ...
                for (var c = Math.min(Math.max(t - s.start - s.delay, 0), s.duration) / s.duration, l = isNaN(c) ? 1 : s.easing(c, s.elasticity), p = (c = s.to.strings, s.round), d = [], g = void 0, y = (g = s.to.numbers.length, 0); y < g; y++) {
                    var v = void 0,
                ...
                if (s = c.length)
                    for (g = c[0], l = 0; l < s; l++) p = c[l + 1], y = d[l], isNaN(y) || (g = p ? g + (y + p) : g + (y + " "));
                else g = d[0];
                L[i.type](u.target, i.property, g, n, u.id), i.currentValue = g, r++
            }
            if (r = Object.keys(n).length)
                for (o = 0; o < r; o++) I || (I = f(document.body, "transform") ? "transform" : "-webkit-transform"), m.animatables[o].target.style[I] = n[o].join(" ");
        ...
        function u(t) {
            ...
            if (m.children.length) {
                ...
                if (h >= m.currentTime)
                    ...
                    for (; b--;) v[b].seek(h)
            }(h >= f || !e) && (m.began || (m.began = !0, a("begin")), a("run")), h > u && h < e ? o(h) : (h <= u && 0 !== g && (o(0), y && i()), (h >= e && g !== e || !e) && (o(e), y || i())), a("update"), t >= e && (m.remaining ? (c = s, "alternate" === m.direction && (m.reversed = !m.reversed)) : (m.pause(), m.completed || (m.completed = !0, a("complete"), "Promise" in window && (p(), d = r()))), l = 0)
        }
        t = void 0 === t ? {} : t;
        var s, c, l = 0,
            p = null,
        ...
        return m.reset = function() {
            var t = m.direction,
                e = m.loop;
            for (m.currentTime = 0, m.progress = 0, m.paused = !0, m.began = !1, m.completed = !1, m.reversed = "reverse" === t, m.remaining = "alternate" === t && 1 === e ? 2 : e, o(0), t = m.children.length; t--;) m.children[t].reset()
        }, m.tick = function(t) {
            s = t, c || (c = s), u((l + s - c) * A.speed)
        }, m.seek = function(t) {
            u(n(t))
        }, m.pause = function() {
            var t = C.indexOf(m); - 1 < t && C.splice(t, 1), m.paused = !0
        }, m.play = function() {
            m.paused && (m.paused = !1, c = 0, l = n(m.currentTime), C.push(m), E || T())
        }, m.reverse = function() {
            m.reversed = !m.reversed, c = 0, l = n(m.currentTime)
        }, m.restart = function() {
            m.pause(), m.reset(), m.play()
        }, m.finished = d, m.reset(), m.autoplay && m.play(), m
    }
    var I, M = {
            update: void 0,
            begin: void 0,
        ...
        k = function() {
            ...
            return function(e, r, n, o) {
                if (0 <= e && 1 >= e && 0 <= n && 1 >= n) {
                    ...
                    if (e !== r || n !== o)
                        for (var i = 0; 11 > i; ++i) a[i] = t(.1 * i, e, n);
                    return function(i) {
                        if (e === r && n === o) return i;
                        if (0 === i) return 0;
                        if (1 === i) return 1;
                        ...
                        var c = 3 * (1 - 3 * n + 3 * e) * s * s + 2 * (3 * n - 6 * e) * s + 3 * e;
                        if (.001 <= c) {
                            for (u = 0; 4 > u && 0 !== (c = 3 * (1 - 3 * n + 3 * e) * s * s + 2 * (3 * n - 6 * e) * s + 3 * e); ++u) {
                                var f = t(s, e, n) - i;
                                s = s - f / c
                            }
                            i = s
                            ...
                            var l = 0;
                            do {
                                f = s + (u - s) / 2, c = t(f, e, n) - i, 0 < c ? u = f : s = f
        ...
        F = function() {
            ...
            var e, r = "Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),
                ...
                a = {};
            for (e in n) a.type = e, n[a.type].forEach(function(t) {
                return function(e, n) {
                    o["ease" + t.type + r[n]] = P.fnc(e) ? e : k.apply($jscomp$this, e)
                }
            }(a)), a = {
                type: a.type
            };
    ...
    return A.version = "2.2.0", A.speed = 1, A.running = C, A.remove = function(t) {
        t = b(t);
        for (var e = C.length; e--;)
            for (var r = C[e], n = r.animations, a = n.length; a--;) o(t, n[a].animatable.target) && (n.splice(a, 1), n.length || r.pause())
    }, A.getValue = p, A.path = function(e, r) {
        ...
        return function(t) {
            return {
                el: n,
                property: t,
                totalLength: y(n) * (o / 100)
            }
        }
    }, A.setDashoffset = function(t) {
        var e = y(t);
        return t.setAttribute("stroke-dasharray", e), e
    }, A.bezier = k, A.easings = F, A.timeline = function(t) {
        var e = A(t);
        return e.pause(), e.duration = 0, e.add = function(r) {
            return e.children.forEach(function(t) {
                ...
                var o = n.offset;
                n.autoplay = !1, n.direction = e.direction, n.offset = P.und(o) ? r : d(o, r), e.began = !0, e.completed = !0, e.seek(n.offset), (n = A(n)).began = !0, n.completed = !0, n.duration > r && (e.duration = n.duration), e.children.push(n)
    ...
    o = function(i) {
        ...
        function w(t, e) {
            return this.$element = i(t), e && ("string" !== i.type(e.delay) && "number" !== i.type(e.delay) || (e.delay = {
                show: e.delay,
                hide: e.delay
            })), this.options = i.extend({}, h, e), this._defaults = h, this._name = o, this._targetclick = !1, this.init(), a.push(this.$element), this
        }
        w.prototype = {
            init: function() {
            ...
            destroy: function() {
                ...
                a.splice(t, 1), this.hide(), this.$element.data("plugin_" + o, null), "click" === this.getTrigger() ? this.$element.off("click") : "hover" === this.getTrigger() && this.$element.off("mouseenter mouseleave"), this.$target && this.$target.remove()
            },
            getDelegateOptions: function() {
                var t = {};
                return this._options && i.each(this._options, function(e, i) {
                    h[e] !== i && (t[e] = i)
                }), t
            },
            hide: function(t, e) {
            ...
            displayContent: function() {
                var t, e = this.getElementPosition(),
                ...
                "" === u && (u = this._defaults.height), "auto" !== u && h.height(u), this.options.style && this.$target.addClass(n + "-" + this.options.style), "rtl" !== this.options.direction || h.hasClass(r) || h.addClass(r), this.options.arrow || o.find(".webui-arrow").remove(), o.detach().css({
                    top: f,
                    left: f,
                    display: "block"
                ...
                if (this.$target.css(g.position).addClass(t).addClass("in"), "iframe" === this.options.type) {
                    var m = o.find("iframe"),
                        v = o.width(),
                        y = m.parent().height();
                    "" !== this.options.iframeOptions.width && "auto" !== this.options.iframeOptions.width && (v = this.options.iframeOptions.width), "" !== this.options.iframeOptions.height && "auto" !== this.options.iframeOptions.height && (y = this.options.iframeOptions.height), m.width(v).height(y)
                }
                if (this.options.arrow || this.$target.css({
                        margin: 0
                    }), this.options.arrow) {
                    var w = this.$target.find(".webui-arrow");
                    w.removeAttr("style"), "left" === t || "right" === t ? w.css({
                        top: this.$target.height() / 2
                    }) : "top" !== t && "bottom" !== t || w.css({
            ...
            setTitle: function(t) {
                ...
                t ? ("rtl" !== this.options.direction || e.hasClass(r) || e.addClass(r), e.html(t)) : e.remove()
            },
            hasContent: function() {
            ...
            setContent: function(t) {
                ...
                "string" == typeof t ? o.html(t) : t instanceof i && (o.html(""), this.options.cache ? t.removeClass(n + "-content").appendTo(o) : t.clone(!0, !0).removeClass(n + "-content").appendTo(o)), this.$target = e
            },
            isAsync: function() {
            ...
            setContentASync: function(t) {
                ...
                this.xhr || (this.xhr = i.ajax({
                    ...
                    success: function(o) {
                        e.bindBodyEvents(), t && i.isFunction(t) ? e.content = t.apply(e.$element[0], [o]) : e.content = o, e.setContent(e.content), e.getContentElement().removeAttr("style"), e.displayContent(), e.options.async.success && e.options.async.success(e, o)
                    },
                    complete: function() {
                        e.xhr = null
                    },
            ...
            bindBodyEvents: function() {
                p || (this.options.dismissible && "click" === this.getTrigger() ? v ? d.off("touchstart.webui-popover").on("touchstart.webui-popover", i.proxy(this.bodyTouchStartHandler, this)) : (d.off("keyup.webui-popover").on("keyup.webui-popover", i.proxy(this.escapeHandler, this)), d.off("click.webui-popover").on("click.webui-popover", i.proxy(this.bodyClickHandler, this))) : "hover" === this.getTrigger() && d.off("touchend.webui-popover").on("touchend.webui-popover", i.proxy(this.bodyClickHandler, this)))
            },
            ...
            getPlacement: function(t) {
                var e, i = this.options.container,
                    o = i.innerWidth(),
                    n = i.innerHeight(),
                    s = i.scrollTop(),
                    h = i.scrollLeft(),
                    ...
                    c = "vertical" === e;
                return "auto" === e || l || c ? e = r < o / 3 ? a < n / 3 ? l ? "right-bottom" : "bottom-right" : a < 2 * n / 3 ? c ? a <= n / 2 ? "bottom-right" : "top-right" : "right" : l ? "right-top" : "top-right" : r < 2 * o / 3 ? a < n / 3 ? l ? r <= o / 2 ? "right-bottom" : "left-bottom" : "bottom" : a < 2 * n / 3 ? l ? r <= o / 2 ? "right" : "left" : a <= n / 2 ? "bottom" : "top" : l ? r <= o / 2 ? "right-top" : "left-top" : "top" : a < n / 3 ? l ? "left-bottom" : "bottom-left" : a < 2 * n / 3 ? c ? a <= n / 2 ? "bottom-left" : "top-left" : "left" : l ? "left-top" : "top-left" : "auto-top" === e ? e = r < o / 3 ? "top-right" : r < 2 * o / 3 ? "top" : "top-left" : "auto-bottom" === e ? e = r < o / 3 ? "bottom-right" : r < 2 * o / 3 ? "bottom" : "bottom-left" : "auto-left" === e ? e = a < n / 3 ? "left-top" : a < 2 * n / 3 ? "left" : "left-bottom" : "auto-right" === e && (e = a < n / 3 ? "right-bottom" : a < 2 * n / 3 ? "right" : "right-top"), e
            },
            getElementPosition: function() {
                var t = this.$element[0].getBoundingClientRect(),
                    o = this.options.container,
                    n = o.css("position");
                if (o.is(e.body) || "static" === n) return i.extend({}, this.$element.offset(), {
            ...
            var n = [],
                s = this.each(function() {
                    ...
                    s ? "destroy" === t ? s.destroy() : "string" == typeof t && n.push(s[t]()) : (t ? "string" == typeof t ? "destroy" !== t && (e || (s = new w(this, null), n.push(s[t]()))) : "object" == typeof t && (s = new w(this, t)) : s = new w(this, null), i.data(this, "plugin_" + o, s))
                });
            return n.length ? n : s
        };
        var b = {
